window.FontAwesomeKitConfig = { "asyncLoading": { "enabled": false }, "autoA11y": { "enabled": true }, "baseUrl": "https://ka-p.fontawesome.com", "baseUrlKit": "https://kit.fontawesome.com", "detectConflictsUntil": null, "iconUploads": {}, "id": 95480467, "license": "pro", "method": "css", "minify": { "enabled": true }, "token": "3919625d45", "v4FontFaceShim": { "enabled": true }, "v4shim": { "enabled": true }, "version": "5.15.1" };
! function(t) { "function" == typeof define && define.amd ? define("kit-loader", t) : t() }((function() {
    ...
    function S(t) {
        ...
        this._then = [],
            function(t, e) {
                function n(t) { g(e, t) }
                try { t((function(t) { y(e, t) }), n) } catch (t) { n(t) }
            }(t, this)
    }
    S.prototype = { constructor: S, _state: "pending", _then: null, _data: void 0, _handled: !1, then: function(t, e) { var n = { owner: this, then: new this.constructor(f), fulfilled: t, rejected: e }; return !e && !t || this._handled || (this._handled = !0, "rejected" === this._state && s && m(j, this)), "fulfilled" === this._state || "rejected" === this._state ? m(p, n) : this._then.push(n), n.then }, catch: function(t) { return this.then(null, t) } }, S.all = function(t) {
    ...
    }, S.race = function(t) { if (!Array.isArray(t)) throw new TypeError("You must pass an array to Promise.race()."); return new S((function(e, n) { for (var o, r = 0; r < t.length; r++)(o = t[r]) && "function" == typeof o.then ? o.then(e, n) : e(o) })) }, S.resolve = function(e) { return e && "object" === t(e) && e.constructor === S ? e : new S((function(t) { t(e) })) }, S.reject = function(t) { return new S((function(e, n) { n(t) })) };
    ...
    function P(t, e) {
        ...
        var d = s.map((function(n) { return new E((function(r, a) { _(n.customCss ? c(t) : i(t, { addOn: n.addOn, minify: t.minify.enabled }), e).then((function(i) { r(k(i, o({}, e, { baseUrl: t.baseUrl, version: t.version, id: n.id, contentFilter: function(t, e) { return F(t, e.baseUrl, e.version) } }))) })).catch(a) })) }));
        return E.all(d)
    }
    ...
    function C(t, e) {
        ...
        var n = [];
        return t.v4shim.enabled && n.push(new E((function(n, r) { _(i(t, { addOn: "-v4-shims", minify: t.minify.enabled }), e).then((function(t) { n(T(t, o({}, e, { id: "fa-v4-shims" }))) })).catch(r) }))), n.push(new E((function(n, r) {
            _(i(t, { minify: t.minify.enabled }), e).then((function(t) {
    ...
    function x(t) { "undefined" != typeof MutationObserver && new MutationObserver(t).observe(document, { childList: !0, subtree: !0 }) }
    try {
        if (window.FontAwesomeKitConfig) {
            ...
            (function() {
                ...
                return "js" === t.method ? C(t, e) : "css" === t.method ? P(t, e, (function(t) { L(t), x(t) })) : void 0
            })(I, U).then((function(t) {
                t.map((function(t) { try { M.insertBefore(t, D ? D.nextSibling : null) } catch (e) { M.appendChild(t) } })), U.detectingConflicts && D && L((function() {
                    D.setAttributeNode(document.createAttribute(U.detectionIgnoreAttr));
                    var t = function(t, e) { var n = document.createElement("script"); return e && e.detectionIgnoreAttr && n.setAttributeNode(document.createAttribute(e.detectionIgnoreAttr)), n.src = i(t, { baseFilename: "conflict-detection", fileSuffix: "js", subdir: "js", minify: t.minify.enabled }), n }(I, U);
